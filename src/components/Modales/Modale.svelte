  ...
  >
    ...
    >
      ...
      >
        <!-- Header -->
        <div
          class="flex items-center justify-between bg-[#4A90E2] p-4 border-b border-opacity-100 rounded-t-md border-regular dark:border-box-dark-up"
        >
          <h5
            class="text-[16px] font-semibold leading-normal text-white dark:text-title-dark uppercase"
            id="themedModalLabel"
          >
            {title}
          </h5>
          <button type="button" class="hover:opacity-75" on:click={close}>
            <svg
              ...
              class="w-5 h-5 text-white dark:text-title-dark"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="1.5"
