...
<main>
    ...
    <div class="simpleslide100">
		<div class="simpleslide100-item bg-img1" style="background-image: url('/_files/slide-2.png');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('/_files/slide-3.png');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('/_files/slide-1.png');"></div>
		<!-- <div class="simpleslide100-item bg-img1" style="background-image: url('/_files/slide-5.png');"></div> -->
	</div>

	<div class="flex-col-c-sb size1 overlay1 p-l-75 p-r-75 p-t-20 p-b-40 p-lr-15-sm">
		
		<div class="flex-col-c-m p-l-15 p-r-15 p-t-100 p-b-90">
			<h3 class="l1-txt2 txt-center p-b-55 respon1 pt-[100px]">
