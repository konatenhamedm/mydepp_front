<script lang="ts">
  ...
  function getLabel(tableData: any[], id: any) {
    if (!id || !tableData) return "Non renseigné";
    const item = tableData.find(i => String(i.id) === String(id));
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:0.5rem; padding:1.5rem; box-shadow:0 1px 2px rgba(0,0,0,0.03);">
    ...
    <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:1rem; padding-left:2.75rem;">
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.civilite, formdata?.civilite)}</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.nationate, formdata?.nationalite)}</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(professions, formdata?.profession)}</p>
      </div>
      {/if}
    </div>
  </div>
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:0.5rem; padding:1.5rem; box-shadow:0 1px 2px rgba(0,0,0,0.03);">
    ...
    <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:1rem; padding-left:2.75rem;">
      ...
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.typeDiplome, formdata.typeDiplome)}</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.lieuObtentionDiplome, formdata.lieuObtentionDiplome)}</p>
      </div>
      <div>
        <p style="font-size:0.875rem; color:#4b5563;">Situation professionnelle</p>
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.situationProfessionnelle, formdata.situationPro)}</p>
      </div>
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:0.5rem; padding:1.5rem; box-shadow:0 1px 2px rgba(0,0,0,0.03);">
    ...
    <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:1rem; padding-left:2.75rem;">
      <div>
        ...
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.region, formdata?.region)}</p>
      </div>
      <div>
        <p style="font-size:0.875rem; color:#4b5563;">District</p>
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.district, formdata?.district)}</p>
      </div>
      <div>
        <p style="font-size:0.875rem; color:#4b5563;">Ville</p>
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.ville, formdata?.ville)}</p>
      </div>
      <div>
        <p style="font-size:0.875rem; color:#4b5563;">Commune</p>
        <p style="font-weight:500; color:#1f2937;">{getLabel(values.commune, formdata?.commune)}</p>
      </div>
      <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:1rem; padding-left:2.75rem;">
        ...
        {#if formdata.appartenirOrdre === "oui"}
          <div>
            ...
            <p style="font-weight:500; color:#1f2937;">{getLabel(values.ordre, formdata?.ordre)}</p>
          </div>
          <div>
