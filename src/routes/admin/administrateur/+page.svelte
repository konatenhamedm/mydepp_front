...
>
  <Abercrome
    titre="Utilisateurs"
    parent="Paramètres"
    current="Gestion des administrateurs"
  />
      ...
      <div class="p-[20px]">
        <div class="scrollbar overflow-x-auto">
          ...
          >
            <!-- Header -->
            <HeaderTable
              item={["Nom et prénoms", "Email", "Type de compte", "Statut"]}
            />
            ...
            <tbody class="text-gray-700">
              {#if loading && paginatedData.length === 0}
                ...
                <tr>
                  <td
                    colspan="4"
                    class="py-6 text-[14px] text-center text-gray-500"
                  >
                    Chargement en cours...
                  </td>
                </tr>
              {:else if paginatedData.length === 0}
                <tr>
                  <td
                    colspan="4"
                    class="py-6 text-[12px] text-center text-gray-500"
                  >
              ...
              {:else}
                {#each paginatedData as item, i}
                  <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td
                      class="px-4 text-[12px] py-3 border border-gray-200 text-right"
                    >
