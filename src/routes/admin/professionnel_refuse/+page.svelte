<script lang="ts">
  ...
  const path: string = '/admin/dossiers-renouvellement';
...
>
  <Abercrome
    titre="Parametres"
    parent="Dashbord"
    current="dossiers renouvellement"
  />
  ...
  <div class="col-span-12">
    ...
    >
      ...
      >
        ...
        >
          Liste des dossiers renouvellement
        </h1>
      ...
      <div class="p-[20px]">
        <div class="scrollbar overflow-x-auto">
          ...
          >
            <!-- Header -->
            <HeaderTable item={['Nom', 'Prénoms', 'Téléphone', 'Email', 'Profession', 'Action']} />
