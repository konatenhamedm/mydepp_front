<script lang="ts">
  ...
  async function fetchData() {
    loading = true;
    try {
      const res = await apiFetch(true, `/typeDiplome/`);
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="type diplome" />
  <!-- Responsive Toggler -->
...
<Modale bind:open={openAdd} size="xl" title="Créer un type diplôme">
  <Add bind:open={openAdd} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openEdit} size="xl" title="Modifier un type diplôme">
  <Edit bind:open={openEdit} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openShow} size="xl" title="Détails d'un type diplôme">
  <Show bind:open={openShow} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openDelete} size="xl" title="Supprimer type diplôme">
