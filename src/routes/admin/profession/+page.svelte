<script lang="ts">
  ...
  const path: string = '/admin/profession';
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="profession" />
  <!-- Responsive Toggler -->
    ...
    >
      ...
      <div class="p-[20px]">
        <div class="scrollbar overflow-x-auto">
          ...
          >
            <!-- Header -->
            <HeaderTable item={["code", "libelle","Montant renouvellement","Montant nouvelle demande","code generation","Chrono max" ]} />
            <!-- Body -->
              ...
              {:else}
                {#each paginatedData as item, i}
                  <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    >
                    <td class="px-4 text-[14px]  py-3 border border-gray-200"
                      >{item.montantNouvelleDemande}</td
                    >
                    <td class="px-4 text-[14px]  py-3 border border-gray-200"
                      >{item.codeGeneration}</td
                    >
                    <td class="px-4 text-[14px]  py-3 border border-gray-200"
                      >{item.chronoMax}</td
                    >
