<script lang="ts">
  ...
  import type {TypeMission} from '../../../types';
  ...
  const path: string = '/admin/role_admin';
  ...
  async function fetchData() {
    loading = true;
    try {
      const res = await apiFetch(true, '/roles/admin/all?page=' + currentPage);
...
>
  <Abercrome titre="Rôles admin" parent="Dashbord" current="rôles admin" />
  <!-- Responsive Toggler -->
