<script lang="ts">
  ...
  const path: string = '/admin/typeProfession';
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="type profession" />
  <!-- Responsive Toggler -->
...
<Modale bind:open={openDelete} size="xl" title="Supprimer type document">
