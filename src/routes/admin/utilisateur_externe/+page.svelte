<script lang="ts">
  ...
  const path: string = "/admin/utilisateur_externe";
...
>
  <Abercrome
    titre="Utilisateurs"
    parent="Paramètres"
    current="Gestion des utilisateurs externes"
  />
      ...
      <div class="p-[20px]">
        <div class="scrollbar overflow-x-auto">
          ...
          >
            <!-- Header -->
            <HeaderTable
              item={["Email", "Type de compte", "Statut"]}
            />
...
<Modale bind:open={openShow} size="xl" title="Détails de l'utilisateur">
  <Show bind:open={openShow} data={current_data} on:updated={fetchData} />
</Modale>

<Modale bind:open={openDelete} size="xl" title="Supprimer l'utilisateur">
