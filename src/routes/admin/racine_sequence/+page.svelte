<script lang="ts">
  ...
  import type {RacineSequence} from '../../../types';
  ...
  const path: string = '/admin/racine_sequence';
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="racine sequence" />
  <!-- Responsive Toggler -->
...
<Modale bind:open={openAdd} size="xl" title="Créer une racine">
  <Add bind:open={openAdd} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openEdit} size="xl" title="Modifier une racine">
  <Edit bind:open={openEdit} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openShow} size="xl" title="Détails d'une racine">
  <Show bind:open={openShow} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openDelete} size="xl" title="Supprimer racine">
