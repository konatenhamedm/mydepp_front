<script lang="ts">
  ...
  import type {NiveauIntervention} from '../../../types';
  ...
  const path: string = '/admin/niveauIntervention';
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="niveau intervention" />
  <!-- Responsive Toggler -->
  <div class="col-span-12">
    ...
    >
      ...
      >
        ...
        >
          Liste des niveaux d'intervention
        </h1>
      ...
      <div class="p-[20px]">
        <div class="scrollbar overflow-x-auto">
          ...
          >
            <!-- Header -->
            <HeaderTable item={['Code','Libelle','Montant','Montant Renouvellement',]} />
            <!-- Body -->
...
<Modale bind:open={openAdd} size="xl" title="Créer niveau d'intervention">
  <Add bind:open={openAdd} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openEdit} size="xl" title="Modifier niveau d'intervention">
  <Edit bind:open={openEdit} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openShow} size="xl" title="Détails d'niveau d'intervention">
