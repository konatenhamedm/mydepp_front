<script lang="ts">
  ...
  async function fetchData() {
    loading = true;
    try {
      const res = await apiFetch(true, `/ordre/`);
...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="ordre" />
  <!-- Responsive Toggler -->
...
<Modale bind:open={openAdd} size="lg" title="Créer un ordre">
  <Add bind:open={openAdd} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openEdit} size="lg" title="Modifier un ordre">
  <Edit bind:open={openEdit} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openShow} size="lg" title="Détails d'un ordre">
  <Show bind:open={openShow} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openDelete} size="lg" title="Supprimer ordre">
