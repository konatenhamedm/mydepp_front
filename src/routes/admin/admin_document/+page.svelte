...
>
  <Abercrome titre="Parametres" parent="Dashbord" current="document" />
  <!-- Responsive Toggler -->
...
<Modale bind:open={openAdd} size="xl" title="Créer un document">
  <Add bind:open={openAdd} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openEdit} size="xl" title="Modifier un document">
  <Edit bind:open={openEdit} data={current_data} on:updated={fetchData} />
</Modale>
<Modale bind:open={openShow} size="xl" title="Détails d'un document">
